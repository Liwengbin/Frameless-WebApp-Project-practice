...
<html>
  ...
  <body class="layout-share-body">
   		...
   		<div class="layout-blogger-main">
			...
			<div class="layout-blogger-menu-con">
				<ul class="ul-blogger-con">
				<c:forEach var="content" items="${contentlist}" varStatus="idx">
					<li>
						<span class="ul-blogger-con span1">$</span>
						<span class="ul-blogger-con span2"><a href="<c:url value="/dynamic"/>?act=lookblogger&u=${content.user_email}&id=${content.blogger_id}">${content.blogger_name}</a>
						<span class="ul-blogger-con span3">${content.blogger_type}</span>
						</span>
						<span class="ul-blogger-con span4">${content.blogger_praise}</span>
						<span class="ul-blogger-con span5">${content.blogger_time}</span>
